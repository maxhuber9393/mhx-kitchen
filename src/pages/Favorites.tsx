  ...
  return (
    <div style={{ padding: '24px 16px', minHeight: '100vh', backgroundColor: '#0f172a', color: 'white', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px' }}>
        ...
        <h1 style={{ fontSize: '20px', fontWeight: 'bold', margin: 0 }}>⭐ Favoriten</h1>
        ...
        <div style={{
          ...
          <div style={{ width: '100%', display: 'flex', justifyContent: 'flex-end' }}>
            <button 
              ...
              style={{ backgroundColor: '#334155', color: 'white', border: 'none', width: '40px', height: '40px', borderRadius: '50%', fontSize: '20px', cursor: 'pointer' }}
            >
              ✕
            </button>
          </div>
          ...
          <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%' }}>
            <img src={activePhoto.url} alt="Großansicht" style={{ maxWidth: '100%', maxHeight: '75vh', objectFit: 'contain', borderRadius: '12px' }} />
          </div>

          <div style={{ backgroundColor: '#1e293b', border: '1px solid #334155', borderRadius: '16px', padding: '12px 20px', display: 'flex', alignItems: 'center', gap: '12px', width: '100%', maxWidth: '400px', justifyContent: 'space-around' }}>
            <button onClick={() => toggleFavorite(activePhoto.id)} style={{ background: 'none', border: 'none', fontSize: '24px', cursor: 'pointer', color: '#f59e0b' }}>
              ⭐
            </button>
            <button onClick={() => handleWhatsAppShare(activePhoto.url)} style={{ backgroundColor: '#25d366', color: 'white', border: 'none', padding: '10px 16px', borderRadius: '8px', fontSize: '14px', cursor: 'pointer' }}>
              💬 Teilen
            </button>
            <button onClick={() => handleDownload(activePhoto.url)} style={{ backgroundColor: '#3b82f6', color: 'white', border: 'none', padding: '10px 16px', borderRadius: '8px', fontSize: '14px', cursor: 'pointer' }}>
              💾 Sichern
            </button>
          </div>
        </div>
